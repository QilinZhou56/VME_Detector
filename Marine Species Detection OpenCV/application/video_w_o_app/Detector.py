...
class Detector:
    def __init__(self, videoPath, configPath, modelPath, classesPath):
        ...
        self.net.setInputSize(320, 320) # Image size
        self.net.setInputScale(1.0/127.5) # Rescale image to -1 to 1 
        self.net.setInputMean((127.5, 127.5, 127.5))
        self.net.setInputSwapRB(True) # BGR format -> RGB
    ...
    def onVideo(self):
        ...
        (success, image) = cap.read() # flag, frame
        ...
        while success:
            ...
            # eliminates all the overlapping bounding boxes
